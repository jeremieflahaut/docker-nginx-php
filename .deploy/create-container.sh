...
&& touch /etc/php/7.4/mods-available/redis.ini && echo extension=redis.so > /etc/php/7.4/mods-available/redis.ini \
...
&& touch /etc/php/7.4/mods-available/mongodb.ini && echo extension=mongodb.so > /etc/php/7.4/mods-available/mongodb.ini \
&& ln -s /etc/php/7.4/mods-available/mongodb.ini /etc/php/7.4/fpm/conf.d/mongodb.ini \
&& ln -s /etc/php/7.4/mods-available/mongodb.ini /etc/php/7.4/cli/conf.d/mongodb.ini \
&& touch /etc/php/7.4/mods-available/xdebug.ini && echo zend_extension=xdebug.so > /etc/php/7.4/mods-available/xdebug.ini \
&& ln -s /etc/php/7.4/mods-available/xdebug.ini /etc/php/7.4/fpm/conf.d/xdebug.ini \
&& ln -s /etc/php/7.4/mods-available/xdebug.ini /etc/php/7.4/cli/conf.d/xdebug.ini
